...
knitr::include_graphics("Imagenes/Cap_6_D-mmbI.png", error=FALSE)
```
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/Cap_6_D-mmb2.png", error=FALSE)
```
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/L1.png", error=FALSE)
```
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/L2.png", error=FALSE)
```
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/DiagramaDeVenn.png", error=FALSE)
```

Finalmente, recordemos gráficamente al deducible y el monto máximo de beneficio:

```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/Simplyin8minutes.png", error=FALSE)
```

_Figura:_ https://www.youtube.com/watch?v=EfmTWu2yn5Q&feature=youtu.be

```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/Cap_6_Payoffencortoylargo.png", error=FALSE)
```
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/DeducibleYMonto.png", error=FALSE)
```
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/Cap_6_VideoDerivadoconProb.png", error=FALSE)
```
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/Cap_6_S_Com_grafica.png", error=FALSE)
```
