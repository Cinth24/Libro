...
knitr::include_graphics("Imagenes/recta.png", error=FALSE)
```
...
```
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/Dist_exponencial.png", error=FALSE)
```
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/DistribucionGama.png", error=TRUE)
```
...
```
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/DistribucionLog-Normal.png", error=TRUE)
```
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/DistribucionWeibull.png", error=TRUE)
```
...
```
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/DistribucionBurr.png", error=TRUE)
```
...
\end{eqnarray*}
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/DistribucionPareto.png", error=TRUE)
```
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/Actuariof.png", error=TRUE)
```
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/Dist_Gamma.png", error=TRUE)
```
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/Mezclas.png", error=TRUE)
```
...
knitr::include_graphics("Imagenes/asipos.png", error=TRUE)
```

Si $\alpha$=0, entonces la distribución es "simétrica".

```{r echo=FALSE, out.width="50%", fig.align='center'}
knitr::include_graphics("Imagenes/simetria.png", error=TRUE)
```

Si $\alpha<$ 0, entonces la distribución es "asimétrica negativa (o"asimétrica a la izquierda).

```{r echo=FALSE, out.width="50%", fig.align='center'}
knitr::include_graphics("Imagenes/Asineg.png", error=TRUE)
```
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/Func_dist_empirica.png", error=TRUE)
```
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/Distribucionempirica.png", error=TRUE)
```
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/Video_FV.png", error=TRUE)
```
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/Detalledelasdiferencias.png", error=TRUE)
```
...
knitr::include_graphics("Imagenes/p-value1.png", error=TRUE)
```

Dado un estadístico de prueba, este podría caer en la **región de "aceptación" (no-rechazo)** o en la **región de rechazo**.

```{r echo=FALSE, out.width="70%", fig.align='center'}
knitr::include_graphics("Imagenes/p-value2.png", error=TRUE)
```
...
```{r echo=FALSE, out.width="70%", fig.align='center'}
knitr::include_graphics("Imagenes/p-value3.png", error=TRUE)
```
...
```{r echo=FALSE, out.width="70%", fig.align='center'}
knitr::include_graphics("Imagenes/p-value4.png", error=TRUE)
```
...
```{r echo=FALSE, out.width="70%", fig.align='center'}
knitr::include_graphics("Imagenes/p-value5.png", error=TRUE)
```
