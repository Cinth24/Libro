...
knitr::include_graphics("Imagenes/13_QR.png", error=FALSE)
```

_Link de YouTube:_ https://www.youtube.com/watch?v=LbDaSLqyfYE

```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/13_RP.png", error=FALSE)
```

_Link de YouTube:_ https://www.youtube.com/watch?v=xUroi0VZll4

```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/13_RNP-EL.png", error=FALSE)
```

_Link de YouTube:_ https://www.youtube.com/watch?v=pGP_bK8x2-U

```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/13_RNP-StopLoss.png", error=FALSE)
```
...
_ Introducción a la teoría del Riesgo, L. Rincón, pág: 86_
