...
knitr::include_graphics("Imagenes/12_HarryP.png", error=FALSE)
```
...
knitr::include_graphics("Imagenes/TablaDist.png", error=FALSE)
```

_Cudro 1: Distribuciones de la clase (a,b,0)_

```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/12_Formula_Panjer.png", error=FALSE)
```
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/12_Formula_PR.png", error=FALSE)
```
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/12_Formula_P.png", error=FALSE)
```
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/Tabli.png", error=FALSE)
```
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/MC_FormulaPager.png", error=FALSE)
```
...
```{r echo=FALSE, out.width="50%"}
knitr::include_graphics("Imagenes/MC_FormulaPager1.png", error=FALSE)
```
...
knitr::include_graphics("Imagenes/Values.png", error=FALSE)
```
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/FormuPanj.png", error=FALSE)
```
