...
knitr::include_graphics("Imagenes/8_RectaAseguradoyAseguradora.png", error=FALSE)
```
...
```{r echo=FALSE, out.width="70%", fig.align='center'}
knitr::include_graphics("Imagenes/Severidad_Anexo.png", error=FALSE)
```
...
```{r echo=FALSE, out.width="70%", fig.align='center'}
knitr::include_graphics("Imagenes/8_Fx.png", error=FALSE)
```
...
```{r echo=FALSE, out.width="70%", fig.align='center'}
knitr::include_graphics("Imagenes/8_Sx.png", error=FALSE)
```     
...
```{r echo=FALSE, out.width="70%", fig.align='center'}
knitr::include_graphics("Imagenes/8_R1.png", error=FALSE)
```  
...
```{r echo=FALSE, out.width="70%", fig.align='center'}
knitr::include_graphics("Imagenes/8_R2.png", error=FALSE)
```  
...
```{r echo=FALSE, out.width="70%", fig.align='center'}
knitr::include_graphics("Imagenes/8_R3.png", error=FALSE)
``` 
...
```{r echo=FALSE, out.width="70%", fig.align='center'}
knitr::include_graphics("Imagenes/8_SxII.png", error=FALSE)
```