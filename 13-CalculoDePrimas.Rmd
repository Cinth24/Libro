...
knitr::include_graphics("Imagenes/flujo.PNG", error=FALSE)
```
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/TimeLine.png", error=FALSE)
```
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/calculo_primas1.png", error=FALSE)
```
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/14_a.png", error=FALSE)
```
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/14_b.png", error=FALSE)
```
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/14_c.png", error=FALSE)
```
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/14_d.png", error=FALSE)
```
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/14_e.png", error=FALSE)
```
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/14_f.png", error=FALSE)
```
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/14_g.png", error=FALSE)
```
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/14_h.png", error=FALSE)
```
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/14_i.png", error=FALSE)
```
...
_Principio Esscher_
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/14_j.png", error=FALSE)
```
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("Imagenes/14_k.png", error=FALSE)
```
