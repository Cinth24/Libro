...
knitr::include_graphics("Imagenes/tabla1-P-M_Pril.jpg", error=FALSE)
```
...
knitr::include_graphics("Imagenes/tabla1-SA_QI.jpg", error=FALSE)
```
...
```{r echo=FALSE, out.width="70%", fig.align='center'}
knitr::include_graphics("Imagenes/tabla3-Pril.jpg", error=FALSE)
```

Se traduce a simplemente tomar:

```{r echo=FALSE, out.width="70%", fig.align='center'}
knitr::include_graphics("Imagenes/tabla4-Pril.jpg", error=FALSE)
```
...
```{r echo=FALSE, out.width="70%", fig.align='center'}
knitr::include_graphics("Imagenes/Probabilidadesdereclamacion.jpg", error=FALSE)
```

```{r echo=FALSE, out.width="70%", fig.align='center'}
knitr::include_graphics("Imagenes/Grafica1_5.jpg", error=FALSE)
```
...
```{r echo=FALSE, out.width="40%", fig.align='center'}
knitr::include_graphics("Imagenes/tabla5-Pril.jpg", error=FALSE)
```

```{r echo=FALSE, out.width="70%", fig.align='center'}
knitr::include_graphics("Imagenes/Figura1_6.jpg", error=FALSE)
```
...
```{r echo=FALSE, out.width="70%", fig.align='center'}
knitr::include_graphics("Imagenes/tabla6-Pril.jpg", error=FALSE)
```
...
- De Pril ($i$)
```{r echo=FALSE, out.width="70%", fig.align='center'}
        knitr::include_graphics("Imagenes/ModIndFormulas_1.png", error=FALSE)
```
<p style="text-align: center">https://youtu.be/bFPe9cODvD4</p>
        
```{r echo=FALSE, out.width="70%", fig.align='center'}
        knitr::include_graphics("Imagenes/ModIndFormulas_2.png", error=FALSE)
```
...
- De Pril ($ii$)
        ```{r echo=FALSE, out.width="70%", fig.align='center'}
        knitr::include_graphics("Imagenes/ModIndFormulas_3.png", error=FALSE)
        ```
